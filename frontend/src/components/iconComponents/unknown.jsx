const UnknownIcon = () => {
  return (
    <svg className="unknown" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" 
      viewBox="0 0 318.293 318.293" xmlSpace="preserve">
    <g>
